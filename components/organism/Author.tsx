        ...
        <>
            <div className="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <div className="items-start space-y-2 xl:grid  xl:gap-x-8 xl:space-y-0">
                    <div className="flex flex-col items-center lg:items-start space-x-2 pt-8">
                        <Image 
                            src='/1675665465045.jpeg'
                            alt="Risam, S.T"
                            width={192}
                            height={192}
                            className="h-48 w-48 rounded-2xl shadow-2xl shadow-black mb-5"
                        />
                        <h3 className="pt-4 pb-2 text-2xl leading-8 font-bold tracking-tight">Risam, S.T</h3>
                        <div className="text-gray-500 dark:text-gray-400 text-center">Electronics Engineer, Home-App Technician, Web Programmer</div>
                    </div>
                    <div className="prose dark:prose-invert max-w-none pt-8 pb-8 xl:col-span-2 text-justify">
